            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                promise = new Promise(function (resolve, reject) {
                    ...
                    request.on('end', function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        var hmac, topic, domain, webhookId, missingHeaders, statusCode, responseError, headers, generatedHash, graphqlTopic, webhookEntry, error_2;
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!reqBody.length) {
                                    ...
                                    Object.entries(request.headers).map(function (_a) {
                                        ...
                                        switch (header.toLowerCase()) {
                                            ...
                                            case base_types_1.ShopifyHeader.Domain.toLowerCase():
                                                domain = value;
                                                break;
                                            case base_types_1.ShopifyHeader.WebhookId.toLowerCase():
                                                webhookId = value;
                                                break;
                                        }
                                    });
                                    ...
                                    if (!webhookId) {
                                        missingHeaders.push(base_types_1.ShopifyHeader.WebhookId);
                                    }
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    return [4 /*yield*/, webhookEntry.webhookHandler(graphqlTopic, domain, reqBody, webhookId)];
                                case 2:
                                    _a.sent();
